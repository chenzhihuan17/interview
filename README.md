...
💡 侧边目录支持方式：[📚 Docsify 文档](https://interview.huihut.com)、[Github + TOC 导航](https://github.com/jawil/GayHub)（[TOC预览.png](https://gitee.com/zhihuanchen/interview/tree/master/images/TOC预览.png)）

📄 保存为 PDF 方式：使用 Chrome 浏览器打开 <a href="https://interview.huihut.com">📚 Docsify 文档</a> 页面，缩起左侧目录-右键 - 打印 - 选择目标打印机是另存为PDF - 保存（[打印预览.png](https://gitee.com/zhihuanchen/interview/tree/master/images/打印预览.png)）
...
![面向对象特征](https://gitee.com/zhihuanchen/interview/tree/master/images/面向对象基本特征.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/SqStack.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/SqQueue.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/SqLoopStack.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/SqList.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/LinkQueue.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/LinkList.png)

##### 双向链表（Du-Link-List）

双向链表图片

![](https://gitee.com/zhihuanchen/interview/tree/master/images/DuLinkList.png)

##### 循环链表（Cir-Link-List）

循环链表图片

![](https://gitee.com/zhihuanchen/interview/tree/master/images/CirLinkList.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/HashTable.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/GeneralizedList1.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/GeneralizedList2.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/SqBinaryTree.png)

##### 链式存储

二叉树链式存储图片

![](https://gitee.com/zhihuanchen/interview/tree/master/images/LinkBinaryTree.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/Self-balancingBinarySearchTree.png)
...
![大端序](https://gitee.com/zhihuanchen/interview/tree/master/images/CPU-Big-Endian.svg.png)
![小端序](https://gitee.com/zhihuanchen/interview/tree/master/images/CPU-Little-Endian.svg.png)
...
![计算机网络体系结构](https://gitee.com/zhihuanchen/interview/tree/master/images/计算机网络体系结构.png)
...
![IP 数据报格式](https://gitee.com/zhihuanchen/interview/tree/master/images/IP数据报格式.png)

#### ICMP 网际控制报文协议

ICMP 报文格式：

![ICMP 报文格式](https://gitee.com/zhihuanchen/interview/tree/master/images/ICMP报文格式.png)
...
![TCP 报文](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP报文.png)

TCP 首部

![TCP 首部](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP首部.png)
...
![UDP 报文](https://gitee.com/zhihuanchen/interview/tree/master/images/UDP报文.png)

UDP 首部

![UDP 首部](https://gitee.com/zhihuanchen/interview/tree/master/images/UDP首部.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/利用可变窗口进行流量控制举例.png)
...
![](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP拥塞窗口cwnd在拥塞控制时的变化情况.png)
![](https://gitee.com/zhihuanchen/interview/tree/master/images/快重传示意图.png)
![](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP的拥塞控制流程图.png)

#### TCP 传输连接管理

> 因为 TCP 三次握手建立连接、四次挥手释放连接很重要，所以附上《计算机网络（第 7 版）-谢希仁》书中对此章的详细描述：<https://gitee.com/zhihuanchen/interview/tree/master/images/TCP-transport-connection-management.png>

##### TCP 三次握手建立连接

![UDP 报文](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP三次握手建立连接.png)
...
> [《计算机网络（第 7 版）-谢希仁》](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP-transport-connection-management.png)

##### TCP 四次挥手释放连接

![UDP 报文](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP四次挥手释放连接.png)
...
![TCP 的有限状态机](https://gitee.com/zhihuanchen/interview/tree/master/images/TCP的有限状态机.png)
...
![Socket 客户端服务器通讯](https://gitee.com/zhihuanchen/interview/tree/master/images/socket客户端服务器通讯.jpg)
...
![WindowsLoadLibrary](https://gitee.com/zhihuanchen/interview/tree/master/images/WindowsLoadLibrary.png)

##### FreeLibrary

![WindowsFreeLibrary](https://gitee.com/zhihuanchen/interview/tree/master/images/WindowsFreeLibrary.png)
